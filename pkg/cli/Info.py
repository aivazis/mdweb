...
# declaration
class Info(mdweb.shells.command, family='mdweb.cli.info'):
    """
    Display helpful information about various aspects of the application
    """


    @mdweb.export(tip="display host information")
    def host(self, plexus, **kwds):
        ...
        # make a channel
        channel = journal.info("mdweb.info.host")
        # report
    ...
    @mdweb.export(tip="display platform information")
    def platform(self, plexus, **kwds):
        ...
        # make a channel
        channel = journal.info("mdweb.info.platform")
        # report
    ...
    @mdweb.export(tip="display user information")
    def user(self, plexus, **kwds):
        ...
        # make a channel
        channel = journal.info("mdweb.info.user")
        # report
