...
# declaration
class Complete(mdweb.shells.command, family="mdweb.cli.complete"):
    """
    Assist with shell auto-completion
    """

    word = mdweb.properties.str()
    word.doc = "the word we are attempting to auto-complete"

    line = mdweb.properties.str()
    line.doc = "the partial command line"


    # administrative
    @mdweb.export(tip="generate completions candidates from a partial command line")
